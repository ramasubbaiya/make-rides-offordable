...
<head>
    ...
    <link name="author" href="Ramasubbaiya Adaikkalam" />
...
<!-- Contact Icon end here -->
	...
	<section class="container main-wrapper">
		...
		<section class="newsletter row fade-down" style="display:none">      
			
            <form action="ramasubbaiya@gmail.com" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="contact col-md-6 fade-down validate" target="_blank" novalidate>
		...
		<footer class="fade-down">        
			<p class="footer-text">&copy; UX 2016, All Rights Reserved.</p>
		</footer>
		<!-- Footer end here -->
	</section>
<!-- About start here -->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content pop-up pop-up-cnt">
        ...
        if(isset($_POST['submit'])){
        	...
        	$to="ramasubbaiya@gmail.com"; // Add your e-mail here
        	if($code!=$captcha){
        ...
        <div class="clearfix cnt-wrap">
          ...
          <div class="col-md-4 col-sm-4">      
            ...
            <h4>Email</h4>
            <p>ramasubbaiya@gmail.com<br />ramasubbaiya@gmail.com</p>
          </div>
          <div class="col-md-4 col-sm-4">
